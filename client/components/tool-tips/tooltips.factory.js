  ...
  angular.module('tooltipsModule', [])
    ...
    function tooltipsFactory(){
      ...
      'diagram, so that all three representations of the regular expression are always in sync</p></div>',
        ...
        'question-regexinput': '<div class="tooltip"><p>Enter your regex here. When components are dragged on or off of the visual diagram ' +
      ...
      'railroad above to create a diagram that is read left to right</p></div>',

        'question-railroad': '<div class="tooltip"><p>This is the railroad. A syntax diagram generated by the regular expression entered above will be displayed here. You can also create a syntax diagram by dragging and dropping components from the library below onto this workspace, as well as move components along the railroad or remove them</p></div>'
      };
